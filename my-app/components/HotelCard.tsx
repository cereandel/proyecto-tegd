...
export function HotelCard({ name, location, price, rating, imageUrl, onClick }: HotelCardProps) {
  return (
    <div className="bg-white overflow-hidden shadow-sm cursor-pointer transition-all hover:shadow-lg hover:scale-[1.02]" style={{ borderRadius: '24px' }} onClick={onClick}>
