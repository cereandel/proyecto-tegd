...
import { Calendar, MapPin, ChevronRight, Clock, ArrowRight, X, AlertTriangle, Wifi, Coffee, Dumbbell, Users, CreditCard, Phone, Mail, FileText, Check, XCircle } from "lucide-react";
...
const getHotelTags = (hotelId: number) => {
  ...
  const shuffled = [...allHotelTags].sort(() => (seed * 9301 + 49297) % 233280 - 116640);
        ...
        <div
          ...
          style={{
            backgroundColor: isUpcoming
              ...
              : "white",
            borderRadius: "12px",
            border: isUpcoming ? "1px solid rgba(255, 255, 255, 0.2)" : "1px solid #E5E7EB",
          }}
        >
      ...
      >
        <DialogHeader className="text-left">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <DialogTitle className="text-2xl text-left" style={{ color: "#111827" }}>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center justify-between">
              <span className="text-gray-600 text-sm">Tipo de Habitación</span>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">A partir de las 3:00 PM</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 mb-1">Check-out</p>
                <p className="text-gray-900">{reservation.checkOut}</p>
                <p className="text-xs text-gray-500 mt-1">Hasta las 11:00 AM</p>
              </div>
            </div>
            <div className="mt-3 pt-3 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                {reservation.nights} {reservation.nights === 1 ? "noche" : "noches"} de estadía
              </p>
            </div>
          </div>
          ...
          {!isCanceling && !isCanceled && !showCancelError ? (
            ...
            >
              <DialogHeader>
                ...
                <DialogTitle className="text-center text-xl" style={{ color: "#111827" }}>
                  ¿Cancelar Reserva?
                </DialogTitle>
                <DialogDescription className="text-center pt-2">
                  Estás a punto de cancelar tu reserva en <strong>{reservation.hotelName}</strong> para el {reservation.checkIn}.
                </DialogDescription>
              </DialogHeader>
              ...
              >
                <p className="text-sm text-gray-800">
                  <strong>Nota:</strong> Dependiendo de la política de cancelación, podrías no recibir un reembolso completo.
                </p>
              </div>
            ...
            >
              <motion.div
                ...
                transition={{ duration: 0.4, type: "spring" }}
              >
                <XCircle size={40} style={{ color: "#EF4444" }} strokeWidth={2.5} />
              </motion.div>
              <motion.h3
                className="text-xl mb-2"
                style={{ color: "#111827" }}
