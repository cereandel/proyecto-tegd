...
export function Register({ onNavigateToLogin, onRegister }: RegisterProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simular proceso de creación con 2 etapas
    setTimeout(() => {
      setIsCreating(false);
      
      // Para simular error de correo ya en uso, descomenta la siguiente línea:
      // const emailInUse = formData.email === "test@test.com";
      ...
      if (emailInUse) {
        ...
        setIsCreated(true);
        // Después de mostrar cuenta creada, navegar a login
        setTimeout(() => {
          setIsCreated(false);
          setTimeout(() => {
            onNavigateToLogin();
  ...
  const handleChange = (field: string, value: string) => {
    ...
    if ((field === "password" || field === "confirmPassword") && formErrors.password) {
    ...
    <>
      ...
      <div className="flex-1 px-6 py-8 pb-12">
        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          ...
          <div className="mb-2">
            <label className="block mb-2 text-gray-700">Confirmar contraseña</label>
            <div className="relative">
              <Lock className="absolute left-5 top-1/2 transform -translate-y-1/2 text-gray-400" size={20} />
              <input
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Check size={60} style={{ color: "#34C759" }} strokeWidth={3} />
              </motion.div>
            </motion.div>
            <motion.h2
